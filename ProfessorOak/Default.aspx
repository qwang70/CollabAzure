                  ...
                  <div class="row">
                    <div class="col-md-6">
                       <div class="form-group">
                                ...
                                <asp:TextBox class="form-control input-lg" id="nicknameInput" runat="server" Height="49px" Width="188px"/>

                            </div>

                            <div class="form-group">
                                <label class="control-label" for="focusedInput">Age</label>
                                <asp:TextBox class="form-control input-lg" id="ageInput" runat="server" Height="55px" Width="182px"/>
                                ...
                                <label class="control-label" for="focusedInput">Recent Mode</label>
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <img src="Asset/mode/n1p1.jpg" width="50px"/>
                        <br />
                        <!--Remember to onclick-->&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                        <br />
                        <!--Remember to onclick-->
