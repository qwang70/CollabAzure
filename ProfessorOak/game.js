...
var myGameArea =  {
  ...
  start: function(canvasWidth, canvasHeight) {
    ...
    this.backgroud.src = '~/Asset/pokemon/background.png';
...
var gameboard = {
  ...
  init: function() {
    this.digitOne = Image();
    tihs.digitOne.src = '~/Asset/pokemon/one.jpeg';
  },
...
function startGame() {
  ...
  pokeballComponent = new pokeball(
    20, canvasHeight - 60, 40, '~/Asset/pokemon/Pokeball.png');
  pokemon = new gameComponentFromImg(
    canvasWidth / 2, pokemonStart, 80, '~/Asset/pokemon/pokemon.gif');
